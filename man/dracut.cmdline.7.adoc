...
**ip=**__<client-IP>__:[__<peer>__]:__<gateway-IP>__:__<netmask>__:__<client_hostname>__:__<interface>__:__{none|off|dhcp|on|any|dhcp6|auto6|ibft}__[:[__<dns1>__][:__<dns2>__]]::
    ...
    for pointopoint interfaces and it may be followed by a slash and a decimal
    number, encoding the network prefix length.
    __<netmask>__ can be specified either in four digit dot separated notation
    or as decimal number network prefix length.

[listing]
.Example
--
    ip=192.168.100.99::192.168.100.222:255.255.255.0:myhost:ens10
    ip=192.168.100.99::192.168.100.222:24:myhost:ens10
    ip=[2001:DB8:2::99]::[2001:DB8:2::1]:8:myhost:ens10
--
