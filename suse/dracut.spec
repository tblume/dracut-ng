...
install -m 0644 dracut.conf.d/ima/50-ima.conf %{buildroot}%{_sysconfdir}/dracut.conf.d/50-ima.conf
%endif
# bsc#915218
%ifarch s390 s390x
...
%files fips
%license COPYING
%config %{_sysconfdir}/dracut.conf.d/50-fips.conf
...
%files ima
%license COPYING
%config %{_sysconfdir}/dracut.conf.d/50-ima.conf
...
%exclude %{dracutlibdir}/modules.d/01fips-crypto-policies
%endif
